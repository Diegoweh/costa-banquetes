...
export function Footer() {
  return (
    <footer className="bg-yellow-700/70 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-700 hover:text-yellow-400 transition-colors">
                {/* Twitter / X */}
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p>México 82110</p>
              <p className="mt-4">
                <a href="tel:+526699135344" className="hover:text-yellow-400 transition-colors">
                  +52 669 913 5344
                </a>
              </p>
              <p>
                <a href="mailto:info@hotelcostadeoro.mx" className="hover:text-yellow-400 transition-colors">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-700">
